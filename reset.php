...
<head>
	...
	<title>Empleo Cusco - Restablecer Contraseña</title>
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
								...
								<strong>No podemos usar este token porque</strong><br>
                                 <li>Este token es inválido</li>
								 <li>Este token ya se ha usado</li>
	                          </div>
                                  ';
								 $invalid_token = true;
                                ...
                                <input class="form-control" placeholder="Min 8 y Max 20 caracteres" name="confirmpassword" required type="password"> 
                                </div>
...
print '
<div class="modal-footer text-center">
<button type="submit" onclick="return val();"  class="btn btn-primary">Restablecer</button>
</div>';	
}
