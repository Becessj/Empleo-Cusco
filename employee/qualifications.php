...
<head>
	...
	<title>Empleo Cusco - Calificaciones Profesionales</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Calificaciones Profesionales</span></li>
					</ol>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2>Calificaciones Profesionales</h2>
									...
									<a href="app/drop-qualification.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('¿Está seguro de que desea eliminar esta calificación?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
							        ...
							        <div class="form-group"> 
								    <label>Adjuntar tu Certificado <b>*(Deje en blanco si no desea actualizar)*</b></label>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Agregar Calificaciones Profesionales</h4>
				                    </div>
							        ...
							        <div class="form-group"> 
								    <label>Titulo</label>
								    <input class="form-control" placeholder="Ingresa el título que lograste" type="text" name="course" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Periodo de Tiempo de Estudio</label>
								    <input class="form-control" placeholder="Ejm: 2013 a 2019" type="text" name="timeframe" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Adjuntar tu Certificado (1 MB)</label>
