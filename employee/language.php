...
<head>
	...
	<title>Empleo Cusco - Dominio del Idioma</title>
											...
											<div class="row">
														...
														<a >
															...
															<div class="row">
																<div class="col-sm-12 col-md-12">
																	<i class="fa fa-user mr-5"></i> Habla - <strong class="mr-10"><?php echo $row['speak']; ?></strong> <i class="fa fa-book mr-5"></i> Lectura - <strong class="mr-10"><?php echo $row['reading']; ?></strong> <i class="fa fa-pencil mr-5"></i> Escritura - <strong class="mr-10"><?php echo $row['writing']; ?></strong>
																</div>
												...
												<div class="col-sm-12 col-md-2">
													...
													<div class="resume-list-btn">
														...
														<a href="app/drop-language.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('¿Está seguro de que desea eliminar este idioma?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
									                    ...
									                    <option <?php if ($row ['speak'] == "Bajo") { print ' selected '; } ?> value="Bajo">Bajo</option>
									                    <option <?php if ($row ['speak'] == "Bueno") { print ' selected '; } ?> value="Bueno">Bueno</option>
								                    	<option <?php if ($row ['speak'] == "Muy bueno") { print ' selected '; } ?> value="Muy bueno">Muy bueno</option>
									                    </select>
							                            </div>
									                    ...
									                    <option <?php if ($row ['reading'] == "Bajo") { print ' selected '; } ?> value="Bajo">Bajo</option>
									                    <option <?php if ($row ['reading'] == "Bueno") { print ' selected '; } ?> value="Bueno">Bueno</option>
								                    	<option <?php if ($row ['reading'] == "Muy bueno") { print ' selected '; } ?> value="Muy bueno">Muy bueno</option>
									                    </select>
							                            </div>
									                    ...
									                    <option <?php if ($row ['writing'] == "Bajo") { print ' selected '; } ?> value="Bajo">Bajo</option>
									                    <option <?php if ($row ['writing'] == "Bueno") { print ' selected '; } ?> value="Bueno">Bueno</option>
								                    	<option <?php if ($row ['writing'] == "Muy bueno") { print ' selected '; } ?> value="Muy bueno">Muy Bueno</option>
									                    </select>
							                            </div>
