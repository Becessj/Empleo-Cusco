...
<head>
	...
	<title>Empleo Cusco - Experiencia</title>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
														...
														<a>
															...
															<div class="row">
																...
																<div class="col-sm-12 col-md-5 mt-10-sm">
																	<i class="fa fa-calendar  text-primary mr-5"></i> <?php echo "$start_date"; ?> <b>a</b> <?php echo "$end_date"; ?>
																</div>
															</div>
									...
									<a href="app/drop-experience.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('¿Está seguro de que desea eliminar esta experiencia?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
								    ...
								    <input value="<?php echo "$institution"; ?>" class="form-control" placeholder="Ingresa Nombre de la Institución" type="text" name="institution" required> 
							        </div>
								    ...
								    <input value="<?php echo "$supervisor"; ?>" class="form-control" placeholder="Ingrese Nombre del supervisor" type="text" name="supervisor"> 
							        </div>
								    ...
								    <input value="<?php echo "$phone"; ?>" class="form-control" placeholder="Ingrese telefono supervisor" type="text" name="telphone"> 
							        </div>
								    ...
								    <input  value="<?php echo "$title"; ?>" class="form-control" placeholder="Ingrese Título del empleo" type="text" name="jobtitle" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Fecha inicio <b style="color:#990000">*</b></label>
								    <input  value="<?php echo "$start_date"; ?>" class="form-control" placeholder="Ejm: 12/12/2017" type="text" name="startdate" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Fecha culminación <b style="color:#990000">*</b></label>
                                   ...
                                   <input type="hidden" name="expid" value="<?php echo "$expid"; ?>">
							        ...
							        <div class="form-group"> 
								    <label>Deberes y responsabilidades</label>
								...
								?>
							        ...
							        <div class="form-group"> 
								    <label>Fecha Inicio <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Ejm: 12/12/2021" type="text" name="startdate" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Fecha Culminación <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Ejm: 12/12/2021" type="text" name="enddate" required> 
							        </div>
