...
<head>
	...
	<title>Empleo Cusco - Empleos de interés</title>
			...
			<br>
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Empleos de interés</span></li>
					</ol>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
                                  ...
                                  foreach($result as $row)
                                  {
									...
									?>
																	   <a  href="../explore-job.php?jobid=<?php echo "$job_id"; ?>" class="recent-job-item clearfix">
								<div class="GridLex-grid-middle">
									...
									<div class="GridLex-col-3_xs-4_xss-12">
                                     <?php echo "$sta"; ?>
										<span class="font12 block spacing1 font400 text-center"><?php echo "$post_date"; ?>/<?php echo "$post_month"; ?>/<?php echo "$post_year"; ?></span>
									</div>
								</div>
							</a>
