...
<head>
	...
	<title>Empleo Cusco - Prácticas</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Prácticas Pre profesionales</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-training.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this training ?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Prácticas Pre profesionales</h4>
				                    </div>
							        ...
							        <div class="form-group"> 
								    <label>Nombre de prácticas que desarrolló</label>
								    <input class="form-control" placeholder="Ingrese Nombre de prácticas que desarrolló" type="text" name="training" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Adjuntar tu Certificado (opcional)</label>
								    <input class="form-control" accept="application/pdf" type="file" name="certificate"> 
							        </div>
