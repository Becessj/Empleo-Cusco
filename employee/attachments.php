...
<head>
	...
	<title>Empleo Cusco - Otra Documentación</title>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-attachment.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('¿Está seguro de que desea eliminar este archivo adjunto?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
								    ...
								    <input class="form-control" value="<?php echo "$att_title"; ?>" placeholder="Ejm: Licencia de conducir, DNI, etc" type="text" name="title" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Emisor</label>
								    <input class="form-control" value="<?php echo "$att_issuer"; ?>" placeholder="Ingrese el emisor" type="text" name="issuer" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Seleccionar Adjunto <i>(Dejar en blanco si no desea actualizar)</i></label>
								...
								?>
							        ...
							        <div class="form-group"> 
								    <label>Tipo de Documentación</label>
								    <input class="form-control" placeholder="Ejm: Licencia de conducir, DNI, etc" type="text" name="title" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Entidad</label>
								    <input class="form-control" placeholder="Ingrese entidad" type="text" name="issuer" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Seleccionar adjunto</label>
