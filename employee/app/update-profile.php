...
$fname = utf8_encode(utf8_decode(($_POST['fname'])));
$lname = utf8_encode(utf8_decode(($_POST['lname'])));
$mydate = $_POST['date'];
$mymonth = $_POST['month'];
$myyear = $_POST['year'];
$myemail = $_POST['email'];
$myregister = $_POST['register'];
...
$about = utf8_encode(utf8_decode($_POST['about']));
$phone = $_POST['phone'];
$country = $_POST['country'];
    ...
    try {
    	...
    	$stmt = $conn->prepare("UPDATE tbl_users SET first_name = :fname, last_name = :lname, gender = :gender, bdate = :bdate , bmonth = :bmonth , byear = :byear, email = :email, register = :register, education = :education, title = :title, city = :city, street = :street, zip = :zip, country = :country, phone = :phone, about = :about WHERE member_no='$myid'");
    	...
    	$stmt->bindParam(':email', $myemail);
    	$stmt->bindParam(':register', $myregister);
        ...
        $_SESSION['myregister'] = $myregister;
