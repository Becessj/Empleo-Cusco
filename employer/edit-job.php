											...
											<?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-8 col-md-8">
													...
													<div class="form-group">
														<label>Título de Empleo</label>
														<input name="title" value="<?php echo "$jobtitle"; ?>" required type="text" class="form-control" placeholder="Ingresa titulo del empleo">
													</div>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label>Región</label>
														<input name="city" value="<?php echo "$jobcity"; ?>"  required type="text" class="form-control" placeholder="Ingresa región">
													</div>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														...
														<select name="country" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           foreach($result as $row)
                                                           {
		                                                    ?> <option <?php if ($jobcountry == $row['country_name']) { print ' selected '; } else {
    		                                                                        print ' disabled ';
											    ...
											    <div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														...
														<input  name="deadline" required type="date" class="form-control" value="<?php echo "$closingdate"; ?>" placeholder="Eg: 30/12/2018">
													</div>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option <?php if ($jobtype == "CAS") { print ' selected '; } ?> value="CAS" data-content="<span class='label label-warning'>CAS</span>">CAS</option>
															<option <?php if ($jobtype == "Prácticas") { print ' selected '; } ?> value="Prácticas" data-content="<span class='label label-danger'>Prácticas</span>">Prácticas</option>
															<option <?php if ($jobtype == "Locación") { print ' selected '; } ?> value="Locación" data-content="<span class='label label-success'>Locación</span>">Locación</option>
														</select>
													</div>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="experience" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															<option value="" selected  >Seleccionar</option>
															<option <?php if ($experience == "Sin Experiencia") { print ' selected '; } ?> value="Sin Experiencia">Sin Experiencia</option>
															<option <?php if ($experience == "2 años") { print ' selected '; } ?> value="2 años">2 Años</option>
															<option <?php if ($experience == "3 años") { print ' selected '; } ?> value="3 años">3 Años</option>
															<option <?php if ($experience == "4 años") { print ' selected '; } ?> value="4 años">4 Años</option>
															<option <?php if ($experience == "5 años a más") { print ' selected '; } ?> value="5 años a más">5 Años a más</option>
														</select>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea class="form-control bootstrap3-wysihtml5" name="description" required placeholder="Ingresa descripción del empleo ..." style="height: 200px;"><?php echo "$jobdescription"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="responsiblities" required class="form-control bootstrap3-wysihtml5" placeholder="Ingrese funciones y requerimientos del empleo..." style="height: 400px;"><?php echo "$jobrespo"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="requirements" required class="form-control bootstrap3-wysihtml5" placeholder="Ingrese el URL de la convocatoria..." style="height: 70px;"><?php echo "$jobreq"; ?></textarea>
													</div>
