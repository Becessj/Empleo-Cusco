...
<head>
	...
	<title>Empleo Cusco - Interesados del empleo <?php echo "$job_title"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Interesados en el empleo <?php echo "$job_title"; ?></</span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Interesados en el empleo <?php echo "$job_title"; ?></</h3>
						</div>
					...
					<div class="employee-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
                            ...
                            $result = $stmt->fetchAll();
							 foreach($result as $row)
                            {
							$post_date = date_format(date_create_from_format('Y-m-d', $row['application_date']), 'd');
                            $post_month = date_format(date_create_from_format('Y-m-d', $row['application_date']), 'm');
                            $post_year = date_format(date_create_from_format('Y-m-d', $row['application_date']), 'Y');
							...
							
							{
								...
								?>
									...
									<div class="employee-grid-item">
										...
										<a href="../employee-detail.php?empid=<?php echo $rowb['member_no']; ?>" class="clearfix"> 
											...
											<div class="content">
												...
												<h6 class="text-primary">Educación : <?php echo $rowb['education'] ?></h6>
												
                                                <h6 class="text-primary"><?php echo $rowb['title'] ?></h6>
												Le interesó el: <?php echo "$post_date"; ?>/<?php echo "$post_month"; ?>/<?php echo "$post_year"; ?>
