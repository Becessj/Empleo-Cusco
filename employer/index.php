...
<head>
	...
	<title>Empleo Cusco - Perfil intitución</title>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-item for-employer">
										...
										<?php 
										if ($logo == null) {
										print '<center>Logo Institución aquí</center>';
										}else{
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2>Perfil de la institución</h2>
											...
											<div class="row gap-20">
												...
												<div class="col-sm-12 col-md-8">
													...
													<div class="form-group">
														<label>Nombre de Intitución</label>
														<input name="company" placeholder="Enter Nombre de Intitución" type="text" class="form-control" value="<?php echo "$compname"; ?>" required>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label>Historia de la Institución</label>
														<textarea name="background" class="bootstrap3-wysihtml5 form-control" placeholder="Ingresa historia de la intitución ..." style="height: 200px;"><?php echo "$desc"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label>Servicios que brinda</label>
														<textarea name="services" class="bootstrap3-wysihtml5 form-control" placeholder="Ingresa servicios que brinda la intitución ..." style="height: 200px;"><?php echo "$myserv"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label>Link de Convocatorias</label>
														<textarea name="expertise" class="bootstrap3-wysihtml5 form-control" placeholder="Ingresa el link de Convocatorias ..." style="height: 80px;"><?php echo "$myex"; ?></textarea>
													</div>
