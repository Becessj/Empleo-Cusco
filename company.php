...
<head>
	...
	<title>Empleo Cusco - <?php echo "$compname"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="employers.php">Intituciones</a></li>
							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-header text-center">
										...
										<ul class="meta-list clearfix">
											...
											<li>
												...
												<a href="https://<?php echo "$compweb"; ?>"><?php echo "https://$compweb"; ?></a>
									...
									<div class="company-detail-company-overview clearfix">
										...
										<h3>Descripción de la Institución</h3>
									...
									<div class="section-title mb-40">
										...
										<h4 class="text-left">Empleos ofrecidos en la <?php echo "$compname"; ?></h4>
