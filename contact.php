...
<head>
	...
	<title>Empleo Cusco - Contactanos</title>
					...
					<div class="row">
							...
							<form class="contact-form-wrapper" data-toggle="validator" action="app/send-message.php" method="POST" autocomplete="off">
								...
								<!-- 	<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<textarea id="inputMessage" name="message" class="form-control" rows="8" data-minlength="50" data-error="Su mensaje es obligatorio y no debe tener menos de 50 caracteres." required></textarea>
											<div class="help-block with-errors"></div>
										</div>
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Dirección</h5>
										<address> Cusco, Perú <br/> </address>
								</li>
								<li>
										<h5>Correo Electrónico</h5><a href="mailto:informatica@guamanpoma.org">informatica@guamanpoma.org</a>
								</li>
								<li>
										<h5>Teléfono</h5><a href="tel:+5194346546546">+5194346546546</a>
								</li>
