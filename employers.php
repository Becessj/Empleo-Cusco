...
<head>
	...
	<title>Empleo Cusco - Instituciones</title>
						...
						<div class="GridLex-grid-middle">
							...
							<div class="GridLex-col-3_sm-12_xs-12">
								...
								<div class="sorting-header">
									<h3 class="sorting-title">Instituciones</h3>
								</div>
					...
					<div class="company-grid-wrapper top-company-2-wrapper">
						...
						<div class="GridLex-gap-30">
							...
							<a href="company.php?ref=<?php echo $row['member_no']; ?>">
								...
								<p class="mata-p clearfix"><span class="text-primary font700">Ver</span> <span class="font13">Puesto(s) de trabajo activo(s)</span> <span class="pull-right icon"><i class="fa fa-long-arrow-right"></i></span></p>
								</div>		
							</a>		
							</div>
