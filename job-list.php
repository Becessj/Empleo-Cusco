...
<?php 
    ...
    //Esto muestra todos los empleos en orden descendente
	
	if (isset($_GET['country']) && ($_GET['category']) ){
	    if($_GET['country'] == $TodosCountry && $_GET['category'] == $TodosCate){
	        $query1 = "SELECT * FROM tbl_jobs WHERE title LIKE '%$cate%'";
	        $query2 = "SELECT * FROM tbl_jobs ORDER BY enc_id DESC";	
            //$query1 = "SELECT * FROM tbl_jobs ORDER BY enc_id DESC LIMIT $page1,12";
        	//$query2 = "SELECT * FROM tbl_jobs ORDER BY enc_id DESC";	
        	$slc_country = "$country";
        	$slc_category = "$cate";
        	$title = "Lista de todos los Empleos";
        }
	    else if($_GET['category'] == $TodosCate){
            $cate = $_GET['category'];
        	$country = $_GET['country'];
            $query1 = "SELECT * FROM tbl_jobs WHERE title LIKE '%$cate%' OR country = :country ORDER BY enc_id DESC LIMIT  $page1,12";
        	$query2 = "SELECT * FROM tbl_jobs ORDER BY enc_id DESC";	
        	$fromsearch=true;
        	$slc_country = "$country";
        	$slc_category = "$cate";
        	$title = "Todos los empleos publicados por la municipalidad de $slc_country";
        }
        else if($_GET['country'] == $TodosCountry){
            $cate = $_GET['category'];
        	$country = $_GET['country'];
            $query1 = "SELECT * FROM tbl_jobs WHERE title LIKE '%$cate%' ORDER BY enc_id DESC LIMIT  $page1,12";
        	$query2 = "SELECT * FROM tbl_jobs ORDER BY enc_id DESC";	
            $fromsearch=true;
        	$slc_category = "$cate";
        	$slc_country = $country;
        	$title = "Todas las municipalidades que publicaron empleos relacionados a $cate";
        }
        else if (isset($_GET['country']) && ($_GET['category']) ){
        	$cate = $_GET['category'];
        	$country = $_GET['country'];	
        	$query1 = "SELECT * FROM tbl_jobs WHERE title LIKE '%$cate%' AND country = '$country' ORDER BY enc_id DESC LIMIT $page1,12";
        	$query2 = "SELECT * FROM tbl_jobs ORDER BY enc_id DESC";
        	$fromsearch=true;
        	$slc_country = "$country";
        	$slc_category = "$cate";
        	$title = "Empleos de $slc_category para la Municipalidad Distrital de $slc_country";
        	}
        else{
        	$query1 = "SELECT * FROM tbl_jobs ORDER BY enc_id DESC LIMIT $page1,12";
        	$query2 = "SELECT * FROM tbl_jobs ORDER BY enc_id DESC";	
...
<head>
	...
	<title>Empleo Cusco - <?php echo "$title"; ?></title>
							...
							<div class="row">
								...
								<div class="col-xss-12 col-xs-6 col-sm-6 col-md-5">
									<div class="form-group form-lg">
										...
										<option value="Todos">-Selecciona Categoría-</option>
								...
								<div class="col-xss-12 col-xs-6 col-sm-6 col-md-5">
									<div class="form-group form-lg">
										...
										<option value="Todos">-Selecciona Distrito-</option>
										<option value="Todos">Todos</option>
										 <?php
										 require 'constants/db_config.php';
										 try {
					...
					<div class="result-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-25">
								...
								if ($type == "Locación") {
									$sta = '<span class="job-label label label-success">Locación</span>';
											  
								}
								if ($type == "Prácticas") {
									$sta = '<span class="job-label label label-danger">Prácticas</span>';
											  
								}
								if ($type == "CAS") {
									$sta = '<span class="job-label label label-warning">CAS</span>';
										...
										<div class="content">
												...
												<div class="row">
													...
													<div class="col-sm-7 col-md-8">
														...
														<div class="meta-div clearfix mb-25">
															<span>para la <a href="company.php?ref=<?php echo "$compid"; ?>"><?php echo "$thecompname"; ?></a>   </span><br><br>
														     <?php echo "$sta"; ?>
														</div>
											...
											<div class="job-item-list-bottom">
												...
												<div class="row">
													...
													<div class="col-sm-5 col-md-4">
														<a href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-success">Ver Empleo</a>
													</div>
