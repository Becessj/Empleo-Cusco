...
<label>Nombre de la Intitución</label>
<input class="form-control" placeholder="Ingresa el nombre de la Institución" name="company" required type="text"> 
</div>
...
<div class="form-group"> 
<label>Rubro de la Intitución</label>
<input class="form-control" placeholder="Ejm: Municipalidad/Institución Pública, etc" name="type" required type="text"> 
</div>
